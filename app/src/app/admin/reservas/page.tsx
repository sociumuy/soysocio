...
const RESERVAS_MOCK = [
  { socio: 'García, Rodrigo', espacio: 'Gimnasio', hora: '07:00', estado: 'confirmada' },
  { socio: 'Sosa, Valentina', espacio: 'Pileta', hora: '08:00', estado: 'confirmada' },
  { socio: 'Méndez, Carlos', espacio: 'Cancha de Tenis', hora: '09:00', estado: 'confirmada' },
  { socio: 'López, Ana', espacio: 'Gimnasio', hora: '10:00', estado: 'confirmada' },
  { socio: 'Fernández, Mateo', espacio: 'Sauna', hora: '11:00', estado: 'confirmada' },
  { socio: 'Rodríguez, Laura', espacio: 'Squash', hora: '14:00', estado: 'confirmada' },
  { socio: 'Pérez, Diego', espacio: 'Gimnasio', hora: '17:00', estado: 'confirmada' },
]

const ESPACIOS = ['Todos', 'Gimnasio', 'Pileta', 'Cancha de Tenis', 'Sauna', 'Squash']
  ...
  return (
    <div className="max-w-3xl">
      <div className="mb-6">
        ...
        <p className="text-[#888] text-sm mt-1">Agenda de hoy — {new Date().toLocaleDateString('es-UY', { weekday: 'long', day: 'numeric', month: 'long' })}</p>
      </div>
